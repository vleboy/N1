...
class MerchantModel extends BaseModel {
    ...
    async page(token, inparam) {
        let query = {
            ...
            ProjectionExpression: 'userId,sn,displayId,displayName,msn,parent,parentName,parentDisplayName,parentRole,balance,gameList,createdAt,loginAt,#status,remark,uname,username,#role,points,isTest,skin',
